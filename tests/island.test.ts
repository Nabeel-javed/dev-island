...
test('palette names cannot resolve inherited object properties',()=>{for(const name of ['toString','constructor','__proto__'])assert.equal(readAppearance(new URLSearchParams('palette='+name)).palette,'lagoon');});
